...
@endif
  ...
  <div class="table-responsive col-md-8">
    @can('admin')
      <a href="/dashboard/ustads/create" class="btn btn-primary mb-3">Tambah Ustaz</a>
    @endcan
    <table class="table table-striped table-sm table-bordered">
      <thead>
        <tr class="text-center">
          ...
          <th scope="col">Kitab yang diampu</th>
          ...
          <td>
            ...
            @can('admin')
              ...
              {{-- <form action="/dashboard/ustads/{{ $ustad->id }}/reset" method="post" class="d-inline">
                @csrf
                <button class="badge btn-warning border-0" onclick="return confirm('Apakah anda yakin?')"><span data-feather="rotate-ccw"></span></button>
              </form> --}}
