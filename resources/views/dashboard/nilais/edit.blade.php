    ...
    <form method="post" action="/dashboard/nilais/{{ $nilai->id }}" class="mb-5">
      ...
      <div class="mb-3">
        ...
        <select class="form-select" name="rumpun_id">
          ...
          @if (old('rumpun_id', $nilai->rumpun_id) == $rumpun->id)
      ...
      <div class="mb-3">
        ...
        <select class="form-select" name="kitab_id">
          ...
          @if (old('kitab_id', $nilai->kitab_id) == $kitab->id)
      ...
      <div class="mb-3">
        ...
        <select class="form-select" name="santri_id">
          ...
          @if (old('santri_id', $nilai->santri_id) == $santri->id)
      ...
      <div class="mb-3">
        ...
        <input type="number" max="100" step="1" min="0" class="form-control @error('nilai') is-invalid @enderror" id="nilai" name="nilai" autofocus required value="{{ old('nilai', $nilai->nilai) }}">
        @error('nilai') 
