...
@section('container')
    ...
    <div class="row justify-content-center mb-1">
      <div class="col-md-12 text-center">
        <p>Category : 
          <a href="/posts?category=announcement" class="text-decoration-none text-dark">Announcement</a>
          |
          <a href="/posts?category=News" class="text-decoration-none text-dark">News</a>
        </p>
      </div>
    </div>
      ...
      <div class="col-md-8">
        <form action="/posts">
          ...
          <div class="input-group mb-3">
            ...
            <button class="btn btn-secondary btn-dark " type="submit">Search</button>
          </div>
        </form>
      </div>
    </div>
